        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              ...
              <br />
              <br />
              My field of Interest's are building fun &nbsp;
              <i>
                <b className="purple">Technologies and Games </b> and
              ...
              with <b className="purple">CNN</b> and
              <i>
                <b className="purple">
                  {" "}
              ...
              &nbsp; like
              <i>
                <b className="purple"> LLM and OpenCV.</b>
              </i>
            </p>
          </Col>
